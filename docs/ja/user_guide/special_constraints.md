...
instance_oh.one_hot_constraints
```
...
list(instance_mix.constraints.keys()), list(instance_mix.indicator_constraints.keys()), \
    list(instance_mix.one_hot_constraints.keys()), list(instance_mix.sos1_constraints.keys())
```
