...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_SOLUTION"].fields_by_name["feasible"]._loaded_options = None
    _globals["_SOLUTION"].fields_by_name["feasible"]._serialized_options = b"\030\001"
