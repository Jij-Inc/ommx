...
class Instance:
    ...
    def promote_sos1_big_m(
        self,
        requests: typing.Sequence[Sos1BigMPromotionRequest],
        *,
        atol: typing.Optional[builtins.float] = None,
    ) -> builtins.list[Sos1BigMPromotion]:
        r"""
...
class OpenSolve:
    ...
    def terminal_state(
        self,
    ) -> typing.Optional[builtins.dict[builtins.str, typing.Any]]:
        r"""
    ...
    def adapter(self) -> typing.Any:
        ...
        """
    @property
    def diagnostics(self) -> typing.Optional[DiagnosticCollector]:
        r"""
        Diagnostics collector stored with this Solve, or `None` when disabled.
        """
    def __enter__(self) -> OpenSolve: ...
    def __exit__(
        self,
        exc_type: typing.Optional[typing.Any] = None,
        exc_value: typing.Optional[typing.Any] = None,
...
class Parameters:
    @staticmethod
    def from_v1_bytes(bytes: bytes) -> Parameters: ...
    def to_v1_bytes(self) -> bytes: ...
...
class SampleSet:
    ...
    @staticmethod
    def from_v1_bytes(bytes: bytes) -> SampleSet: ...
    @staticmethod
...
class Samples:
    ...
    @staticmethod
    def from_v1_bytes(bytes: bytes) -> Samples: ...
    def to_v1_bytes(self) -> bytes: ...
    def num_samples(self) -> builtins.int:
        r"""
...
class Solution:
    ...
    @staticmethod
    def from_v1_bytes(bytes: bytes) -> Solution: ...
    @staticmethod
    def from_v2_bytes(bytes: bytes) -> Solution: ...
    def to_v1_bytes(self) -> bytes: ...
    def to_v2_bytes(self) -> bytes: ...
...
class Sos1BigMPromotionBatchRejectedError(builtins.RuntimeError):
    ...
    def request_count(self) -> builtins.int:
        r"""
        Number of requests in the rejected strict batch.
        """
    @property
    def rejections(self) -> builtins.dict[builtins.int, builtins.str]:
        r"""
        Diagnostic messages keyed by rejected zero-based request index.
        """
