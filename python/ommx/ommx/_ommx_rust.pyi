...
class ConstraintHints:
    @staticmethod
    def from_bytes(bytes: bytes) -> ConstraintHints: ...
    def to_bytes(self) -> bytes: ...
    def one_hot_constraints(self) -> builtins.list[OneHot]: ...
    def k_hot_constraints(self) -> builtins.dict[builtins.int, builtins.list[KHot]]: ...
...
class KHot:
    @staticmethod
    def from_bytes(bytes: bytes) -> KHot: ...
    def to_bytes(self) -> bytes: ...
...
class OneHot:
    @staticmethod
    def from_bytes(bytes: bytes) -> OneHot: ...
    def to_bytes(self) -> bytes: ...
