...
class ArtifactArchive:
    ...
    @staticmethod
    def from_oci_archive(path:builtins.str | os.PathLike | pathlib.Path) -> ArtifactArchive: ...
    def get_blob(self, digest:builtins.str) -> bytes: ...
    def push(self) -> None: ...

class ArtifactArchiveBuilder:
    @staticmethod
    def new_unnamed(path:builtins.str | os.PathLike | pathlib.Path) -> ArtifactArchiveBuilder: ...
    @staticmethod
    def new(path:builtins.str | os.PathLike | pathlib.Path, image_name:builtins.str) -> ArtifactArchiveBuilder: ...
    @staticmethod
    def temp() -> ArtifactArchiveBuilder: ...
    def add_layer(self, media_type:builtins.str, blob:bytes, annotations:typing.Mapping[builtins.str, builtins.str]) -> Descriptor: ...
...
class ArtifactDir:
    ...
    @staticmethod
    def from_oci_dir(path:builtins.str | os.PathLike | pathlib.Path) -> ArtifactDir: ...
    def get_blob(self, digest:builtins.str) -> bytes: ...
    def push(self) -> None: ...
...
class ArtifactDirBuilder:
    ...
    @staticmethod
    def for_github(org:builtins.str, repo:builtins.str, name:builtins.str, tag:builtins.str) -> ArtifactDirBuilder: ...
    def add_layer(self, media_type:builtins.str, blob:bytes, annotations:typing.Mapping[builtins.str, builtins.str]) -> Descriptor: ...
    def add_annotation(self, key:builtins.str, value:builtins.str) -> None: ...
...
class Constraint:
    ...
    def __new__(cls, id:builtins.int, function:Function, equality:Equality, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], description:typing.Optional[builtins.str]=None, parameters:typing.Mapping[builtins.str, builtins.str]={}) -> Constraint: ...
    @staticmethod
    ...
    def set_description(self, description:builtins.str) -> None:
        ...
        """
    def set_parameters(self, parameters:typing.Mapping[builtins.str, builtins.str]) -> None:
        r"""
...
class ConstraintHints:
    ...
    def __new__(cls, one_hot_constraints:typing.Sequence[OneHot]=[], sos1_constraints:typing.Sequence[Sos1]=[]) -> ConstraintHints: ...
    def __repr__(self) -> builtins.str: ...
...
class DecisionVariable:
    ...
    parameters: builtins.dict[builtins.str, builtins.str]
    description: builtins.str
    def __new__(cls, id:builtins.int, kind:builtins.int, bound:Bound, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
    def binary(id:builtins.int, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
    def integer(id:builtins.int, bound:Bound, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
    def continuous(id:builtins.int, bound:Bound, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
    def semi_integer(id:builtins.int, bound:Bound, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
    def semi_continuous(id:builtins.int, bound:Bound, name:typing.Optional[builtins.str]=None, subscripts:typing.Sequence[builtins.int]=[], parameters:typing.Mapping[builtins.str, builtins.str]={}, description:typing.Optional[builtins.str]=None) -> DecisionVariable: ...
    @staticmethod
...
class DecisionVariableAnalysis:
    ...
    def used_in_constraints(self) -> builtins.dict[builtins.int, builtins.set[builtins.int]]: ...
...
class Function:
    ...
    def num_terms(self) -> builtins.int:
        ...
        """
    def almost_equal(self, other:Function, atol:builtins.float=1e-06) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
    ...
    def terms(self) -> dict: ...
    @staticmethod
    def random(rng:Rng, num_terms:builtins.int=5, max_degree:builtins.int=3, max_id:builtins.int=10) -> Function: ...
...
class Instance:
    ...
    @staticmethod
    def from_components(sense:Sense, objective:Function, decision_variables:typing.Mapping[builtins.int, DecisionVariable], constraints:typing.Mapping[builtins.int, Constraint], description:typing.Optional[InstanceDescription]=None, constraint_hints:typing.Optional[ConstraintHints]=None) -> Instance: ...
    ...
    def random_samples(self, rng:Rng, *, num_different_samples:builtins.int=5, num_samples:builtins.int=10, max_sample_id:typing.Optional[builtins.int]=None) -> bytes: ...
    def relax_constraint(self, constraint_id:builtins.int, removed_reason:builtins.str, removed_reason_parameters:typing.Mapping[builtins.str, builtins.str]) -> None: ...
    ...
    def convert_inequality_to_equality_with_integer_slack(self, constraint_id:builtins.int, max_integer_range:builtins.int) -> None: ...
    def add_integer_slack_to_inequality(self, constraint_id:builtins.int, slack_upper_bound:builtins.int) -> typing.Optional[builtins.float]: ...
...
class InstanceDescription:
    ...
    def __new__(cls, name:typing.Optional[builtins.str]=None, description:typing.Optional[builtins.str]=None, authors:typing.Optional[typing.Sequence[builtins.str]]=None, created_by:typing.Optional[builtins.str]=None) -> InstanceDescription: ...
    def __repr__(self) -> builtins.str: ...
...
class Linear:
    linear_terms: builtins.dict[builtins.int, builtins.float]
    constant_term: builtins.float
    def __new__(cls, terms:typing.Mapping[builtins.int, builtins.float], constant:builtins.float=0.0) -> Linear: ...
    @staticmethod
    def single_term(id:builtins.int, coefficient:builtins.float) -> Linear: ...
    @staticmethod
    def constant(constant:builtins.float) -> Linear: ...
    @staticmethod
    def random(rng:Rng, num_terms:builtins.int=3, max_id:builtins.int=10) -> Linear: ...
    @staticmethod
    def decode(bytes:bytes) -> Linear: ...
    def encode(self) -> bytes: ...
    def almost_equal(self, other:Linear, atol:builtins.float=1e-06) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
...
class OneHot:
    ...
    def __new__(cls, id:builtins.int, variables:typing.Sequence[builtins.int]) -> OneHot: ...
    def __repr__(self) -> builtins.str: ...
...
class Polynomial:
    def __new__(cls, terms:typing.Mapping[typing.Sequence[builtins.int], builtins.float]) -> Polynomial: ...
    @staticmethod
    def decode(bytes:bytes) -> Polynomial: ...
    def encode(self) -> bytes: ...
    def almost_equal(self, other:Polynomial, atol:builtins.float=1e-06) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
    ...
    def terms(self) -> dict: ...
    @staticmethod
    def random(rng:Rng, num_terms:builtins.int=5, max_degree:builtins.int=3, max_id:builtins.int=10) -> Polynomial: ...
    def evaluate(self, state:bytes) -> builtins.float: ...
...
class Quadratic:
    ...
    constant_term: builtins.float
    quadratic_terms: builtins.dict[tuple[builtins.int, builtins.int], builtins.float]
    def __new__(cls, columns:typing.Sequence[builtins.int], rows:typing.Sequence[builtins.int], values:typing.Sequence[builtins.float], linear:typing.Optional[Linear]=None) -> Quadratic: ...
    @staticmethod
    def decode(bytes:bytes) -> Quadratic: ...
    def encode(self) -> bytes: ...
    def almost_equal(self, other:Quadratic, atol:builtins.float=1e-06) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
    ...
    def terms(self) -> dict: ...
    @staticmethod
    def random(rng:Rng, num_terms:builtins.int=5, max_id:builtins.int=10) -> Quadratic: ...
    def evaluate(self, state:bytes) -> builtins.float: ...
...
class RemovedConstraint:
    ...
    id: builtins.int
    name: builtins.str
    def __new__(cls, constraint:Constraint, removed_reason:builtins.str, removed_reason_parameters:typing.Optional[typing.Mapping[builtins.str, builtins.str]]=None) -> RemovedConstraint: ...
    @staticmethod
...
class Sos1:
    ...
    variables: builtins.list[builtins.int]
    def __new__(cls, binary_constraint_id:builtins.int, big_m_constraint_ids:typing.Sequence[builtins.int], variables:typing.Sequence[builtins.int]) -> Sos1: ...
    def __repr__(self) -> builtins.str: ...
...
class State:
    ...
    def to_bytes(self) -> bytes: ...
    def set_entries(self, entries:typing.Mapping[builtins.int, builtins.float]) -> None: ...
...
def miplib2017_instance_annotations() -> builtins.dict[builtins.str, builtins.dict[builtins.str, builtins.str]]: ...
