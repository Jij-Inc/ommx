...
def evaluate_function(function: bytes, state: bytes) -> builtins.float: ...
def evaluate_instance(function: bytes, state: bytes) -> bytes: ...
def evaluate_linear(function: bytes, state: bytes) -> builtins.float: ...
def evaluate_polynomial(function: bytes, state: bytes) -> builtins.float: ...
def evaluate_quadratic(function: bytes, state: bytes) -> builtins.float: ...
...
def partial_evaluate_constraint(obj: bytes, state: bytes) -> bytes: ...
def partial_evaluate_function(function: bytes, state: bytes) -> bytes: ...
def partial_evaluate_instance(obj: bytes, state: bytes) -> bytes: ...
def partial_evaluate_linear(function: bytes, state: bytes) -> bytes: ...
def partial_evaluate_polynomial(function: bytes, state: bytes) -> bytes: ...
def partial_evaluate_quadratic(function: bytes, state: bytes) -> bytes: ...
