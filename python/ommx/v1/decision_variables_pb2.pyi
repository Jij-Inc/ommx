...
class DecisionVariable(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_description", b"_description", "bound", b"bound", "description", b"description"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_description", b"_description", "bound", b"bound", "description", b"description", "id", b"id", "kind", b"kind"]) -> None: ...
