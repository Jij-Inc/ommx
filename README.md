...
See [Supported Adapters](https://jij-inc.github.io/ommx/en/user_guide/supported_adapters.ipynb) about a complete list of supported adapters for each solver.
