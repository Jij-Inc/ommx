...
[`Instance::unary_encode`](crate::Instance::unary_encode) rejects variables
whose range width exceeds
[`Instance::DEFAULT_UNARY_ENCODING_MAX_RANGE`](crate::Instance::DEFAULT_UNARY_ENCODING_MAX_RANGE);
use [`Instance::unary_encode_with_max_range`](crate::Instance::unary_encode_with_max_range)
when a different explicit limit is intended.

[`Instance::unary_encode_with_atol`](crate::Instance::unary_encode_with_atol),
[`Instance::unary_encode_with_max_range`](crate::Instance::unary_encode_with_max_range),
and [`Instance::log_encode_with_atol`](crate::Instance::log_encode_with_atol)
use the SDK's ATol-aware integer-bound normalization.
