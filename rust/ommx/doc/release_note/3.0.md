...
callback scope can instead use
[`ExperimentSession`](crate::experiment::ExperimentSession) and
[`RunSession`](crate::experiment::RunSession) for explicit completion. Their
best-effort interrupted fallback on unresolved drop is opt-in.
