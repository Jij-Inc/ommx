...
normalization.
[`Instance::unary_encode_many`](crate::Instance::unary_encode_many) and
[`Instance::log_encode_many`](crate::Instance::log_encode_many) provide
clone-once transactional bulk encoding for callers that encode multiple
variables at once. All encoding entrypoints reject fixed decision-variable IDs
before substitution so fixed values and dependent-variable assignments remain
disjoint.
