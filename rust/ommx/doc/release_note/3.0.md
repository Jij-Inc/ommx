...
## Modeling, transformation, and compatibility
...
promote unverified hints into first-class one-hot or SOS1 constraints. Property
tests can select the full v3 instance domain or narrower v1-compatible,
regular-only, and MPS-compatible spaces through
[`InstanceParameters`](crate::InstanceParameters).

Related PRs: [#1004](https://github.com/Jij-Inc/ommx/pull/1004),
[#1010](https://github.com/Jij-Inc/ommx/pull/1010),
