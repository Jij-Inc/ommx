...
listing is backed by a SQLite projection keyed by the Experiment manifest digest,
and the projection is written in the same transaction as ref updates on commit,
archive import, OCI directory import, and remote pull paths.
