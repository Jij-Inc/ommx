...
The Rust SDK now exposes [`PromotionWitness`](crate::PromotionWitness)
and [`OneHotPromotionWitness`](crate::OneHotPromotionWitness) for
...
variables, and rejects witnesses outside the caller-provided
