...
The earlier [`AdditionalCapability`](crate::AdditionalCapability) and
[`Instance::reduce_capabilities`](crate::Instance::reduce_capabilities) APIs
remain available for explicit special-constraint lowering during the staged
adapter migration. They do not describe regular constraints or establish that
an arbitrary transformed instance is accepted by a solver.
