...
- **🧱 SDK architecture and implementation** — internal data representation,
...
## 🧱 Modeling labels and constraint context on the enclosing collection
...
## 🧱 Decision-variable table ownership
...
## 🧱 Instance-owned decision-variable state
...
## 🧱 OMMX Artifact lifecycle and OCI representation
...
## 🧱 Artifact archives and remote distribution
...
## 🧱 Unified annotations and dataset metadata
...
## 🧱 Formatting and property-test domains
...
## 🧱 Experiment sessions and Run lifecycle
...
## 🧱 Experiment attachments, parameters, and traces
...
## 🧱 Experiment persistence, recovery, and lineage
...
## 🧱 Local Registry lifecycle and inspection
