...
impl Equality {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "EQUALITY_UNSPECIFIED",
            Self::EqualToZero => "EQUALITY_EQUAL_TO_ZERO",
            Self::LessThanOrEqualToZero => "EQUALITY_LESS_THAN_OR_EQUAL_TO_ZERO",
        }
    }
    ...
    impl Kind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Integer => "KIND_INTEGER",
                Self::Continuous => "KIND_CONTINUOUS",
                Self::SemiInteger => "KIND_SEMI_INTEGER",
                Self::SemiContinuous => "KIND_SEMI_CONTINUOUS",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod instance {
    ...
    impl Sense {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "SENSE_UNSPECIFIED",
                Self::Minimize => "SENSE_MINIMIZE",
                Self::Maximize => "SENSE_MAXIMIZE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl Optimality {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "OPTIMALITY_UNSPECIFIED",
            Self::Optimal => "OPTIMALITY_OPTIMAL",
            Self::NotOptimal => "OPTIMALITY_NOT_OPTIMAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl Relaxation {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "RELAXATION_UNSPECIFIED",
            Self::LpRelaxed => "RELAXATION_LP_RELAXED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
